...
void Model::Draw(const glm::mat4 &modelMtx,const glm::mat4 &viewProjMtx,uint shader, glm::vec3 color) {
	// Set up shader
	glUseProgram(shader);
	...
	glUniform3fv(glGetUniformLocation(shader, "LightColor"), 1, &color[0]);
